...
class UserModel extends Model
{
    ...
    public function check_confirm_email_address($purl)
    {
        ...
        // updates the database to confirm the email address
        $params = [
            'id' => $results[0]->id
        ];
    ...
    public function check_if_user_can_recover_password($username)
    {
        ...
        /*
        verifica se o usuario tem conta ativa na base de dados (se está ativo)
            - email existe
            - ativo=1
        */
    }
    ...
    // ======================================================================================
    public function check_if_purl_exists_reset_password($purl)
    {
        $params = [
            'purl' => $purl
        ];
    ...
    // ======================================================================================
    public function update_users_password($id, $passwrd)
    {
        $params = [
            'id' => $id,
            'passwrd' => password_hash($passwrd, PASSWORD_DEFAULT)
